...
namespace SampleCodeDom
{
    ...
    class Sample
    {
        ...
        public void AddFields()
        {
            ...
            testfield.Name = "LoadAtOriginPage1ViewMode";
            testfield.Type =
                new CodeTypeReference("readonly string");
            testfield.InitExpression = new CodePrimitiveExpression("LoadAtOrigin_page1");
            testfield.Comments.Add(new CodeCommentStatement(
                "The LoadAtOriginPage1ViewMode of the object."));
        ...
        public void AddProperties()
        {
            ...
            areaProperty.GetStatements.Add(new CodeSnippetStatement("return (this.widthValue * this.heightValue);"));
        ...
        public void AddMethod()
        {
            ...
            // height, and area.
            string formattedOutput = "Constants.Services.MainMultiViewController";
            returnStatement.Expression =
                new CodeMethodInvokeExpression(
                new CodeTypeReferenceExpression("AppUI.Services"), "Resolve<MultiViewController>",
                new CodeTypeReferenceExpression(formattedOutput));
